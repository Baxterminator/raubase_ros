...
from raubase_msgs.msg import DataEncoder, DataDistance, DataServo, DataLineSensor
from raubase_msgs.msg import ResultYolo, ResultArUco, ResultOdometry, ResultEdge
...
class SharedData:
    ...
    line: DataLineSensor = DataLineSensor()
    edge: ResultEdge = ResultEdge()
