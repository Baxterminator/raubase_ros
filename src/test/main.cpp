...
//   auto client = node->create_subscription<std_msgs::msg::Empty>("/camera/get_image", 10, []()
...
//       "/test", [](const TestService::Request::SharedPtr req, TestService::Response::SharedPtr
//       res) {
//         usleep(1000000);
